...
export function Settings({ settings, data, busy, onSave, onSync, onTest, onImport }: { settings: AppSettings; data: Library; busy: boolean; onSave: (value: AppSettings) => void; onSync: (name: string, tag: string, key: string, count: number) => Promise<void>; onTest: (name: string, tag: string, key: string) => Promise<void>; onImport: (file: File) => Promise<void> }) {
