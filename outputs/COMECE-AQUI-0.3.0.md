...
Esta versão adiciona dois recursos importantes: **Testar conexão** verifica seu Riot ID e chave antes da importação, e **Importar backup** restaura seu histórico em outro computador.
